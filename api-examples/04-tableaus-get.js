...
/* --------------------------------------------------------------------------------------------------------
    Change Log
    - 2023-08-07: Add printout of first tableau
...
function getTableaus(callback) {
    ...
    axios.get(url).then(function (response) {
        ...
        for(tableau of response.data.tableaus) {
            console.log(tableau); 
        }
        
        console.log();

        callback(response.data.tableaus[0].link);
